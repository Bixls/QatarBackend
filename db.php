<?php
    ...
    class DB {
        ...
        function __construct(){
            ...
            if(!$this->mysql){
	          $this->error=true;
            $this->error_messege="Database Connection";
            }
            if(!@mysql_select_db($db,$this->mysql)){
              $this->error=true;
              $this->error_messege="Selecting Database";
            }
            $this->db = $db;
        }
        public function errorMessege(){
          $respond= array('sucess' => false,'cause'=>$this->error_messege );
          return $respond;
        }
        ...
        public function query($query){
            ...
            if(mysql_error($this->mysql) != ''){
              $this->error=true;
              $this->error_messege=mysql_error($this->mysql);
                $this->result = null;
            }
            return $this;
        }
